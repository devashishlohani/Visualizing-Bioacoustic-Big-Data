...
class Plot_embedding:
    ...
    def __init__(self, Y, labels, legend_labels, colors, label_name="", title= None, subtitle=""):
        ...
        ax.legend(scatterpoints=1, title =label_name,bbox_to_anchor=(1.02, 1), loc=2, borderaxespad=0.)                          # Display the legends
   
        plt.title(subtitle)
        plt.subplots_adjust(left=0.01, right=0.85, top=0.90, bottom=0.01)
